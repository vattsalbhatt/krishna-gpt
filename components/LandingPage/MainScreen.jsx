...
function MainScreen() {
  ...
  useEffect(() => {
    const findLocalMessages = JSON.parse(
      ...
      {
        message:
          "Life is a journey of self-discovery. It is a path of learning, understanding, and growth. It is a time to explore our innermost thoughts and feelings, and to discover our true purpose in life. Life is a precious gift, and it is up to us to make the most of it.\n\nLife is a cycle of joy and sorrow, of success and failure",
        type: "received",
        time: new Date(),
      },
      {
  ...
  return (
    <>
      <div
        className="border-black h-[100%]"
        style={{
          fontFamily: "Poppins, sans-serif",
          backgroundColor: "#",
        }}
      >
        <div className="lg:w-[40%] h-[100%] m-auto border-black">
          <div
                ...
                <>
                  {msg.type == "received" && (
                    <div className="receiver mb-1.5">
                      ...
                      <div className="ml-4 text-[10px] tracking-wide mt-[-3px] text-gray-500">
                        <p>
